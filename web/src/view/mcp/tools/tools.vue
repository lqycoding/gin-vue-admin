...
<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="服务id" prop="serverId" width="120">
          <template #default="scope">
                    <span>{{ filterDataSource(dataSource.serverId,scope.row.serverId) }}</span>
         </template>
         </el-table-column>
          <el-table-column align="left" label="工具名称" prop="name" width="120" />
          <el-table-column align="left" label="工具描述" prop="description" width="120" />
          <el-table-column align="left" label="积分消耗" prop="points" width="120" />
          <el-table-column label="输入参数模式(JSON)" prop="input_schema" width="200">
              <template #default="scope">
                  [JSON]
              </template>
          </el-table-column>
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateToolsFunc(scope.row)">编辑</el-button>
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="积分消耗:"  prop="points" >
              <el-input v-model.number="formData.points" :clearable="true" placeholder="请输入积分消耗" />
            </el-form-item>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="服务id">
                       <span>{{ filterDataSource(dataSource.serverId,detailFrom.serverId) }}</span>
                    ...
                    <el-descriptions-item label="输入参数模式(JSON)">
                        {{ detailFrom.input_schema }}
                    </el-descriptions-item>
            </el-descriptions>
        </el-drawer>
